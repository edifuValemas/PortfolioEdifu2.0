<template>
  <div>
    <div class="a-hero_container">
      ...
      <div class="nametag-container contain">
        <div class="h-name" data-aos="fade-up" data-aos-duration="900">
          <nuxt-link to="/about" style="text-decoration: none;">
            <span class="underline-magical">Edisson Fúquene</span>
          </nuxt-link>
        </div>
        <div
          class="h-j-title"
      ...
      >
        <h1>
          <span class="underline-magical-hero">Designer </span>
          <br />
          <span class="outlined">User Experience</span> &
          <br />
          Front End
        </h1>
      </div>
      <div class="contain">
        <p data-aos="fade-up" data-aos-duration="900" data-aos-delay="600">
          Hi, I'm Edisson, a multidisciplinary UI/UX Designer & Front-end Developer. <br/>
          I 
          <span>
            ...
            >
              <span class="underline-magical">Front End</span>
            </a> 
          </span>
        </p>
      </div>
